...
const _lazy_E2i72I = () => import('./renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_E2i72I, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_E2i72I, lazy: true, middleware: false, method: undefined }
];
